...
def scrape_inshorts(page_number):
    ...
    try:
        ...
        #print(f"Page: {page_number}, Rank: {json_response['data']['suggested_news'][0]['rank']}")  # Print rank of the first item
        print(json_response)
    ...
    logging.info(f"Time taken for page {page_number}: {elapsed_time} seconds")
